...
public static class CountryCodes
{
    ...
    /// <summary>
    /// Метод, проверяющий наличие кода страны в справочнике.
    /// </summary>
    /// <param name="countryCodeId">код страны в формате Alpha-2.</param>
    /// <returns>True, если код страны действительный; иначе False</returns>
    public static bool IsValidCountryCode(string countryCodeId)
    {
        return ValidCountryCodes.Contains(countryCodeId);
    }
}